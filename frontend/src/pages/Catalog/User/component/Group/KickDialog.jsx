...
const KickDialog = ({user_id, username, group_name, handleCloseDialog, handleKick}) => {
    ...
    if(currentUser === user_id) {
        return (
            <div>
                ...
                <div className={classes.Container}>
                    ...
                    <div className={classes.Text}>Do you want to leave this group ?</div>
                    <div className={classes.BtnsWrapper}>
                        <button className={classes.KickBtn} onClick={handleKick}>Leave</button>
        ...
        return (
            <div>
                ...
                <div className={classes.Container}>
                    <img className={classes.Mark} src={ExclamationMark} alt="exclamation mark"/>
                    <div className={classes.Text}>kick {username} from group {group_name} ?</div>
                    <div className={classes.BtnsWrapper}>
                        <button className={classes.KickBtn} onClick={handleKick}>Kick</button>
                        <button className={classes.CancelBtn} onClick={handleCloseDialog}>Cancel</button>
                    </div>
                </div>
            </div>
